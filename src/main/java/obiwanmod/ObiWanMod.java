...
import obiwanmod.util.TextureLoader;
...
public class ObiWanMod implements
    ...
    private static final String resourcesFolder = "obiwanmod";
    ...
    private static final Color cardColor = new Color(3/255f, 132/255f, 252/255f, 1f);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(ObiWan.Enums.CARD_COLOR, cardColor,
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(ObiWanMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
