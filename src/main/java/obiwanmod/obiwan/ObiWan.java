...
import static obiwanmod.ObiWanMod.characterPath;
import static obiwanmod.ObiWanMod.makeID;

public class ObiWan extends CustomPlayer {
    //Stats
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass OBI_WAN;
        @SpireEnum(name = "CHARACTER_BLUE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_BLUE_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public ObiWan() {
        super(NAMES[0], Enums.OBI_WAN,
